...
export default function Home() {
  ...
  return (
    <main
      className={`flex min-h-screen items-center justify-center dark:bg-gray-900 ${inter.className}`}
    >
      <div className="flex flex-col w-[95%] max-w-md px-4 py-8 bg-white rounded-lg shadow dark:bg-gray-800 sm:px-6 md:px-8 lg:px-10">
          ...
          <form onSubmit={handleSubmit}>
            <div className="flex flex-col mb-2">
              <div className="flex relative ">
                ...
                <input type="email" required id="sign-in-email" className=" rounded-r-lg flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" placeholder="Your email" />
              </div>
            </div>
